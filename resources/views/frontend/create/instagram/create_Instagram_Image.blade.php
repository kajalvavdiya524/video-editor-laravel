...
@section('content')
    ...
    <form id="adForm" enctype="multipart/form-data">
        ...
        <div class="form-row mt-3">
            <div class="col-project-name form-group">
                <label>Project Name</label>
                <input type="text" name="project_name" class="form-control" value="{{ empty($settings->project_name) ? "" : $settings->project_name }}">
            </div>
            <div class="col-product-layout form-group {{ isset($settings->output_dimensions) && $settings->output_dimensions ? 'd-none' : '' }}">
                <label>Product Layouts</label>
                <select class="form-control" name="product_layouts">
                    <option value="0">Generic</option>
                    <option value="1">Save 1</option>
                    <option value="2">Fun 1</option>
                    <option value="3">4 Products</option>
                </select>
            </div>
        </div>
        <div class="form-row product-ids">
        ...
        <div class="textlines headlines">
            ...
            <div class="form-row">
                ...
                <div class="col-md-1 col-sm-3 form-group">
                    <div class="input-group">
                        <input type="number" name="headline_font_size[]" class="form-control headline_font_size" value="{{ empty($settings->headline_font_size) ? "50" : $settings->headline_font_size[0] }}">
                ...
                <div class="col-md-1 col-sm-3 form-group">
                    <input type="color" name="headline_color_picker[]" class="form-control" value="{{ empty($settings->headline_color) ? "#000000" : $settings->headline_color[0] }}">
                </div>
            </div>
            <div class="form-row {{ !empty($settings->multi_headline) && $settings->multi_headline == "on" ? "" : "d-none" }} multi-headline">
                ...
                <div class="col-md-1 col-sm-3 form-group">
                    <div class="input-group">
                        <input type="number" name="headline_font_size[]" class="form-control headline_font_size" value="{{ empty($settings->headline_font_size) ? "50" : $settings->headline_font_size[1] }}">
                        <div class="input-group-append ml-1 align-items-center">
                            <i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" title="Specify font sizes for multiple templates by separating them with commas, in the same order as listed in Output Dimensions dropdown, below.
                            Or, specify a font size for each template by first selecting a size in Output Dimensions dropdown."></i>
                        </div>
                ...
                <div class="col-md-1 col-sm-3 form-group">
                    <input type="color" name="headline_color_picker[]" class="form-control" value="{{ empty($settings->headline_color) ? "#000000" : $settings->headline_color[1] }}">
                </div>
            </div>
            <div class="form-row {{ !empty($settings->multi_headline) && $settings->multi_headline == "on" ? "" : "d-none" }} multi-headline">
                <div class="col-md-6 col-sm-9 form-group">
                ...
                <div class="col-md-1 col-sm-3 form-group">
                    <div class="input-group">
                        <input type="number" name="headline_font_size[]" class="form-control headline_font_size" value="{{ empty($settings->headline_font_size) ? "50" : $settings->headline_font_size[2] }}">
                        <div class="input-group-append ml-1 align-items-center">
                            <i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" title="Specify font sizes for multiple templates by separating them with commas, in the same order as listed in Output Dimensions dropdown, below.
                            Or, specify a font size for each template by first selecting a size in Output Dimensions dropdown."></i>
                        </div>
                ...
                <div class="col-md-1 col-sm-3 form-group">
                    <input type="color" name="headline_color_picker[]" class="form-control" value="{{ empty($settings->headline_color) ? "#000000" : $settings->headline_color[2] }}">
                </div>
            </div>
        </div>
        <div class="textlines sub-headlines">
            <label>Sub-headline</label>
            <div class="form-row">
                <div class="col-md-6 col-sm-9 form-group">
                    <input type="text" name="subheadline[]" class="form-control" value="{{ empty($settings->subheadline) ? "" : $settings->subheadline }}">
                </div>
                <div class="col-md-1 col-sm-3 form-group">
                ...
                <div class="col-md-1 col-sm-3 form-group">
                    <div class="input-group">
                        <input type="number" name="subheadline_font_size[]" class="form-control subheadline_font_size" value="{{ empty($settings->subheadline_font_size) ? "28" : $settings->subheadline_font_size }}">
                        <div class="input-group-append ml-1 align-items-center">
                            <i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" title="Specify font sizes for multiple templates by separating them with commas, in the same order as listed in Output Dimensions dropdown, below.
                            Or, specify a font size for each template by first selecting a size in Output Dimensions dropdown."></i>
                        </div>
                ...
                <div class="col-md-1 col-sm-3 form-group">
                    <input type="text" name="subheadline_color[]" class="form-control color-hex" placeholder="Color Hex Code" value="{{ empty($settings->subheadline_color) ? "#000000" : $settings->subheadline_color }}">
                </div>
                <div class="col-md-1 col-sm-3 form-group">
                    <input type="color" name="subheadline_color_picker[]" class="form-control" value="{{ empty($settings->subheadline_color) ? "#000000" : $settings->subheadline_color }}">
                </div>
            </div>
        </div>
        <div class="textlines save1-layout d-none">
            <label>Sub-headline 1</label>
            <div class="form-row">
                <div class="col-md-6 col-sm-9 form-group">
                    <input type="text" name="subheadline[]" class="form-control" value="{{ empty($settings->subheadline) ? "" : $settings->subheadline }}">
                </div>
                ...
                <div class="col-md-1 col-sm-3 form-group">
                    <input type="color" class="form-control" value="{{ empty($settings->subheadline_color) ? "#000000" : $settings->subheadline_color }}">
                </div>
            </div>
        ...
        <div class="textlines call-to-action">
            ...
            <div class="form-row">
                ...
                <div class="col-md-1 col-sm-3 form-group">
                    <div class="input-group">
                        <input type="number" name="CTA_font_size" class="form-control CTA_font_size" value="{{ empty($settings->CTA_font_size) ? "20" : $settings->CTA_font_size }}">
                        <div class="input-group-append ml-1 align-items-center">
                            <i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" title="Specify font sizes for multiple templates by separating them with commas, in the same order as listed in Output Dimensions dropdown, below.
                            Or, specify a font size for each template by first selecting a size in Output Dimensions dropdown."></i>
                        </div>
        ...
        <div class="form-row logo-button">
        ...
        <div class="form-row">
            ...
            <div class="col-md-2 col-sm-3 col-6 form-group">
                ...
                <div class="input-group">
                    <input type="number" name="compress_size" class="form-control compress_size" value="{{ empty($settings->compress_size) ? "120" : $settings->compress_size }}">
                    <div class="input-group-append ml-1 align-items-center">
            ...
            <div class="col-md-2 col-sm-4 col-6 form-group text-tracking">
            ...
            <div class="col-md-2 col-sm-3 col-6 form-group drop-shadow">
            ...
            <div class="col-md-3 form-group product-layering">
        ...
        <div class="form-row">
            <div class="col-md-2 col-4 form-group mirror-fade">
                <div class="form-check">
        ...
        <div class="form-row border-stroke">
            <div class="col-md-2 col-sm-3 form-group">
                <div class="form-check">
        ...
        <div class="form-row mb-2">
            <button id="preview-ads" class="btn btn-primary mr-2">Preview</button>
            <button id="download-ads" class="btn btn-primary mr-2">Download</button>
            <button id="generate-ads" class="btn btn-primary mr-2">Save Draft</button>
            ...
            <button id="share-ads" type="button" class="btn btn-primary mr-2">Share...</button>
...
@push("after-scripts")
	...
	<script type="text/javascript" src="{{ asset('js/preview/instagram.js') }}"></script>
@endpush