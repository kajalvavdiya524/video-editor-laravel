		...
		<div class="form-row d-none-parent">
			<div class="col-md-3 form-group">
                ...
                <select name="product_layouts" class="form-control">
                    <option value="0">Upper Left / Lower Right</option>
                    <option value="1">Bottom Offset Right</option>
...
@push("after-scripts")
	...
	<script type="text/javascript" src="{{ asset('js/preview/virtualbundle.js') }}"></script>
@endpush