    ...
    <form id="adForm" enctype="multipart/form-data">
		...
		<div class="form-row d-none-parent">
			<div class="col-md-3 form-group">
				...
				<input type="text" name="product_space" class="form-control" value="{{ empty($settings->product_space) ? "10" : $settings->product_space }}">
			</div>
...
@push("after-scripts")
	...
	<script type="text/javascript" src="{{ asset('js/preview/nutritionfacts.js') }}"></script>
@endpush